...
public class Util
{
    ...
    public static void ClearMemory()
    {
        ...
        LuaManager mgr = LuaManager.Instance;//AppFacade.Instance.GetManager<LuaManager>(ManagerName.Lua);
    ...
    {
        LuaManager luaMgr = LuaManager.Instance;//AppFacade.Instance.GetManager<LuaManager>(ManagerName.Lua);
